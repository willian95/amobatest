...
class RouteDataSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        foreach($routeData as $rd => $data){
            ...
            if(RouteData::where("id", $data["id"])->count() == 0){
                $routeData = new RouteData;
                $routeData->id = $data["id"];
                $routeData->route_id = $data["route_id"];
                $routeData->calendar_id = $data["calendar_id"];
                $routeData->vinculation_route = $data["vinculation_route"];
                $routeData->route_circular = $data["route_circular"];
                $routeData->date_init = $data["date_init"];
                $routeData->date_finish = $data["date_finish"];
                $routeData->mon = $data["mon"]; 
                $routeData->tue = $data["tue"]; 
                $routeData->wed = $data["wed"]; 
                $routeData->thu = $data["thu"]; 
                $routeData->fri = $data["fri"]; 
                $routeData->sat = $data["sat"];
                $routeData->sun = $data["sun"];
                $routeData->max_reservations_per_day = $data["max_reservations_per_day"];
                $routeData->save();
            }
